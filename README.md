...
This means you are free to use, modify, and distribute this software. However, any derivative works that are distributed must also be released under the GPLv3, ensuring the software remains free for all users.
