	...
	class RegisterRequest_tests {
		...
		void testRegisterUser_Success() throws Exception {
			when(authService.registerUser(any(RegisterRequest.class)))
				.thenReturn(new AuthResponse("Registration successful! Please verify your email.",null));
	...
	class SignInRequest_tests {
		...
		void testSignIn_success() throws Exception {
			when(authService.signIn(any(SignInRequest.class)))
				.thenReturn(new AuthResponse("Sign in successful for user: " + validSignInRequest.getEmail(), null));
